...
export default {
    data: new SlashCommandBuilder()
        .setName('mlb')
        .setDescription('Middleman vouch leaderboard')
        .addStringOption((o) =>
            o.setName('period')
    ...
    async execute(interaction) {
        ...
        const cfg = VOUCH_CONFIG.middleman;
        const rows = await getLeaderboard(interaction.guildId, 'middleman', { period, limit: 10 });
        ...
        const embed = createEmbed({
            title: `${cfg.emoji} Middleman Leaderboard`,
