...
export default {
  name: 'setpilotquota',
  aliases: [],
  description: 'Set monthly pilot quota (0 = off).',
  slash: new SlashCommandBuilder()
    .setName('setpilotquota')
    .setDescription('Set monthly pilot quota (0 = off).')
  ...
  async run(ctx) {
    ...
    await setConfig(guild.id, { pilotQuota: amount });
    return reply(ctx, amount === 0 ? '✅ Pilot quota disabled.' : `✅ Pilot monthly quota set to **${amount}**.`);
  },
};
