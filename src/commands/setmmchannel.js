...
export default {
  name: 'setmmchannel',
  aliases: [],
  description: 'Set the middleman channel.',
  slash: new SlashCommandBuilder()
    .setName('setmmchannel')
    .setDescription('Set the middleman channel.')
  ...
  async run(ctx) {
    ...
    await setConfig(guild.id, { mmChannelId: id });
    return reply(ctx, `✅ Middleman channel set to <#${id}>.`);
  },
};
