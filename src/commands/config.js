  ...
  async run(ctx) {
    ...
    const embed = new EmbedBuilder()
      ...
      .addFields(
        ...
        { name: 'Staff Work Quota', value: c.staffQuota > 0 ? String(c.staffQuota) : '_off_', inline: true },
        { name: 'Ticket Quota', value: c.ticketQuota > 0 ? String(c.ticketQuota) : '_off_', inline: true },
        { name: 'Message Quota', value: c.messageQuota > 0 ? String(c.messageQuota) : '_off_', inline: true },
